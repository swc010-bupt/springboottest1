...
public class UserLoginController {
    ...
    public ModelAndView queryAllUser(HttpServletRequest request){
        List<Map<String,Object>> res = userLoginService.queryAllUser();
...
//            u.put("username",username);
            User user1 = userLoginService.getUserbyName(username);
            int age = user1.getAge();
            System.out.println(age);
            request.setAttribute("username",username);
            request.setAttribute("age",age);
            return "mainPage_general_user";
        }
...
//        List<Map<String,Object>> res = (List<Map<String,Object>>)userLoginService.queryAllUser();
////        System.out.println(res.get("password"));
